	...
	template: `
		...
		<div class='modPanel' id='nodeEditor'>
			...
			<div>
				...
				<vw-panel-nodeEditor-existing v-show="tabsprop.selectedMatchingTab==='EXISTING'" v-bind:props="tabsprop.existingMatching"></vw-panel-nodeEditor-existing>
			</div>
			...
			<div>
				...
				<vw-panel-nodeEditor-effects v-show="tabsprop.selectedStyleTab==='EFFECTS'" v-bind:styles="tabsprop.effects"></vw-panel-nodeEditor-effects>
...
Vue.component('vw-panel-nodeEditor-matching', {
	...
	template: `
		<div class ="tabcontent">
			<label>Node type of: </label>
			<input
				v-model.lazy='newMatching.selectedNodeType'>
			</input>
			<label>With properties: <span v-on:click="newMatching.addProperty()" class ="btn btn-sm"><i class ="glyphicon glyphicon-plus"></i></span></label>
			<hr/>
			<table>
...
Vue.component('vw-panel-nodeEditor-styles', {
	...
	template: `
		<div class ="tabcontent">
			...
			<table class="table">
				<tr>
					<td><label>Background Col:</label></td>
					<td>
				...
				<tr>
					<td><label>Circle Text Color: </label></td>
					<td>
						<input class ="jscolor tinybox pull-right"
...
Vue.component('vw-panel-nodeEditor-effects', {
	...
	template: `
		<div class ="tabcontent">
			<table class ="table">
				<tr>
					<td><label>Haze: </label></td>
					<td><input type="checkbox" value="false"></input></td>
				</tr>
				<tr>
					<td><label>Shadow: </label></td>
					<td><input type="checkbox" value="false"></input></td>
				</tr>
				<tr>
					<td><label>Glass: </label></td>
					<td><input type="checkbox" value="false"></input></td>
				</tr>
				<tr>
					<td><label>Rounded: </label></td>
					<td><input type="checkbox" value="false"></input></td>
				</tr>
		...
		tabs: {
			...
			saveMatch: function () {
				...
				tempConfig.config.attributes = {
					...
					"shapes": this.styles.selectedNodeShape,
				...
				if (this.behaviours.selectedDisplayTextType == "Property") {
					tempConfig.config.attributes.labelText.displayData = { key: "property", value: this.behaviours.selectedDisplayField.trim() };
				}
				if (this.behaviours.selectedDisplayTextType == "Type") {
					tempConfig.config.attributes.labelText.displayData = null;
				}
				if (this.behaviours.selectedDisplayTextType == "Static") {
					tempConfig.config.attributes.labelText.displayData = { key: "static", value: this.behaviours.selectedDisplayField.trim() };
				}
				if (this.behaviours.selectedDisplayTextType == "First of") {
					tempConfig.config.attributes.labelText.displayData = { key: "first", value: this.behaviours.selectedDisplayField.split(',').map(function(fieldName){ return fieldName.trim()} ) };
				}
